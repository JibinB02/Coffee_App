              ...
              <View style={styles.CreditCardBG}>
                <LinearGradient
                  ...
                  <View style={styles.CreditCardNumberContainer}>
                    <Text style={styles.CreditCardNumber}>8977</Text>
                    <Text style={styles.CreditCardNumber}>3421</Text>
                    <Text style={styles.CreditCardNumber}>6743</Text>
                    <Text style={styles.CreditCardNumber}>4411</Text>
                  </View>
                  <View style={styles.CreditCardRow}>
                    <View style={styles.CreditCardNameContainer}>
                      ...
                      <Text style={styles.CreditCardNameTitle}>Jibin B</Text>
                    </View>
                    <View style={styles.CreditCardDateContainer}>
                      <Text style={styles.CreditCardNameSubtitle}>
                        Expiry Date
                      </Text>
                      <Text style={styles.CreditCardNameTitle}>09/34</Text>
                    </View>
                  </View>
                </LinearGradient>
              </View>
